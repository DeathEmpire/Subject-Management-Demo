<div class="row">    
    ...
    <?= form_hidden('id', $registro->id); ?>
        ...
        <div class="control-group">
            ...
            <?= form_input(array('type'=>'text', 'name'=>'name', 'id'=>'name', 'value'=>set_value('name', $registro->name), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Direccion: *', 'direccion', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'text', 'name'=>'direccion', 'id'=>'direccion', 'value'=>set_value('direccion', $registro->direccion), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Ciudad/Localidad: *', 'ciudad_localidad', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'text', 'name'=>'ciudad_localidad', 'id'=>'ciudad_localidad', 'value'=>set_value('ciudad_localidad', $registro->ciudad_localidad), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Estado/Provincia: *', 'estado_provincia', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'text', 'name'=>'estado_provincia', 'id'=>'estado_provincia', 'value'=>set_value('estado_provincia', $registro->estado_provincia), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Codigo Zip/Postal: ', 'zip_postal', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'text', 'name'=>'zip_postal', 'id'=>'zip_postal', 'value'=>set_value('zip_postal', $registro->zip_postal), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Pais: *', 'pais', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'text', 'name'=>'pais', 'id'=>'pais', 'value'=>set_value('pais', $registro->pais), 'class'=>'form-control')); ?>
        </div>
        ...
        <div class="control-group">
            ...
            <?= form_input(array('type'=>'text', 'name'=>'contacto_nombre', 'id'=>'contacto_nombre', 'value'=>set_value('contacto_nombre', $registro->contacto_nombre), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <?= form_input(array('type'=>'text', 'name'=>'contacto_fono', 'id'=>'contacto_fono', 'value'=>set_value('contacto_fono', $registro->contacto_fono), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Fax Contacto: ', 'contacto_fax', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'text', 'name'=>'contacto_fax', 'id'=>'contacto_fax', 'value'=>set_value('contacto_fax', $registro->contacto_fax), 'class'=>'form-control')); ?>
        </div>
        <div class="control-group">
            <?= form_label('Email Contacto: ', 'contacto_email', array('class'=>'control-label')); ?>
            <?= form_input(array('type'=>'email', 'name'=>'contacto_email', 'id'=>'contacto_email', 'value'=>set_value('contacto_email', $registro->contacto_email), 'class'=>'form-control')); ?>
        </div>   
        ...
        <div class="control-group">
            ...
            <p class='disabled' style='display:none;'>
                Fecha: <?= form_input(array('type'=>'text', 'name'=>'last_disabled', 'id'=>'last_disabled', 'readonly'=>'readonly', 'style'=>'cursor: pointer;', 'value'=>set_value('last_disabled', $registro->last_disabled)));?></td><br />
