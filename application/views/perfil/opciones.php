					...
					<?php
						...
						elseif ($seccion == 'Sujetos') {
							...
							echo "<div style='font-weight:bold;'>Formulario Historial Medico</div>";
								echo form_checkbox(array('name'=>'ver_historial_medico_form', 'value'=>'historial_medico_show', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'historial_medico_show')) ? true : false))) . " Ver<br>";
								echo form_checkbox(array('name'=>'agregar_historial_medico_form', 'value'=>'historial_medico,historial_medico_insert', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'historial_medico_insert')) ? true : false))) . " Agregar y Responder Querys<br>";
								echo form_checkbox(array('name'=>'actualizar_historial_medico_form', 'value'=>'historial_medico_update', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'historial_medico_update')) ? true : false))) . " Editar<br>";
								echo form_checkbox(array('name'=>'cerrar_historial_medico', 'value'=>'historial_medico_lock', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'historial_medico_lock')) ? true : false))) . " Cerrar<br>";
								echo form_checkbox(array('name'=>'aprobar_historial_medico', 'value'=>'historial_medico_verify', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'historial_medico_verify')) ? true : false))) . " Aprobar y Agregar Querys<br>";
								echo form_checkbox(array('name'=>'firmar_historial_medico', 'value'=>'historial_medico_signature', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'historial_medico_signature')) ? true : false))) . " Firmar<br>";
							...
							echo "<div style='font-weight:bold;'>Eventos Adversos</div>";
								echo form_checkbox(array('name'=>'ver_adverse_event', 'value'=>'adverse_event_form,adverse_event_show,adverse_event_list', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'adverse_event_form')) ? true : false))) . " Ver<br>";
								echo form_checkbox(array('name'=>'agregar_adverse_event', 'value'=>'adverse_event_form_insert', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'adverse_event_form_insert')) ? true : false))) ." Agregar y Responder Querys<br>";
							...
							echo "<div style='font-weight:bold;'>Desviacion de Protocolo</div>";
								echo form_checkbox(array('name'=>'ver_protocol_deviation', 'value'=>'protocol_deviation_form,protocol_deviation_lista,protocol_deviation_show', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'protocol_deviation_form')) ? true : false))) . " Ver<br>";
								echo form_checkbox(array('name'=>'agregar_protocol_deviation', 'value'=>'protocol_deviation_form_insert', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'protocol_deviation_form_insert')) ? true : false))) ." Agregar y Responder Querys<br>";
							...
							echo "<div style='font-weight:bold;'>Medicina Concomitante</div>";
								echo form_checkbox(array('name'=>'ver_concomitant_medication_form', 'value'=>'concomitant_medication_form,concomitant_medication_lista,concomitant_medication_show', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'concomitant_medication_form')) ? true : false))) . " Ver<br>";
								echo form_checkbox(array('name'=>'agregar_concomitant_medication_form', 'value'=>'concomitant_medication_form_insert', 'perfil'=>$v->role, 'controller'=>$v->controller,'checked'=>((strstr($v->actions, 'concomitant_medication_form_insert')) ? true : false))) ." Agregar y Responder Querys<br>";
