		...
		<table class='table table-striped table-hover table-bordered table-condensed'>
			...
			<tbody>
				<tr>
					...
					<td rowspan='2'>1</td>
					<td>9-7</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_1a', 'value'=>set_value('respuesta_1a')));?></td>
				...
				<tr>				
					<td>6-3</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_1b', 'value'=>set_value('respuesta_1b')));?></td>
					<td><?= form_dropdown('puntaje_intento_1b',$valores_intento, set_value('puntaje_intento_1b'),array('id'=>'puntaje_intento_1b')); ?></td>					
				</tr>
				<tr>				
					<td rowspan='2'>2</td>
					<td>5-8-2</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_2a', 'value'=>set_value('respuesta_2a')));?></td>
				...
				<tr>
					<td>6-9-4</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_2b', 'value'=>set_value('respuesta_2b')));?></td>
					<td><?= form_dropdown('puntaje_intento_2b',$valores_intento, set_value('puntaje_intento_2b'),array('id'=>'puntaje_intento_2b')); ?></td>					
				</tr>
				<tr>
					<td rowspan='2'>3</td>
					<td>7-2-8-6</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_3a', 'value'=>set_value('respuesta_3a')));?></td>
				...
				<tr>
					<td>6-4-3-9</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_3b', 'value'=>set_value('respuesta_3b')));?></td>
					<td><?= form_dropdown('puntaje_intento_3b',$valores_intento, set_value('puntaje_intento_3b'),array('id'=>'puntaje_intento_3b')); ?></td>					
				</tr>
				<tr>
					<td rowspan='2'>4</td>
					<td>4-2-7-3-1</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_4a', 'value'=>set_value('respuesta_4a')));?></td>
				...
				<tr>
					<td>7-5-8-3-6</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_4b', 'value'=>set_value('respuesta_4b')));?></td>
					<td><?= form_dropdown('puntaje_intento_4b',$valores_intento, set_value('puntaje_intento_4b'),array('id'=>'puntaje_intento_4b')); ?></td>					
				</tr>
				<tr>
					<td rowspan='2'>5</td>
					<td>3-9-2-4-8-7</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_5a', 'value'=>set_value('respuesta_5a')));?></td>
				...
				<tr>
					<td>6-1-9-4-7-3</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_5b', 'value'=>set_value('respuesta_5b')));?></td>
					<td><?= form_dropdown('puntaje_intento_5b',$valores_intento, set_value('puntaje_intento_5b'),array('id'=>'puntaje_intento_5b')); ?></td>					
				</tr>
				<tr>
					<td rowspan='2'>6</td>
					<td>4-1-7-9-3-8-6</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_6a', 'value'=>set_value('respuesta_6a')));?></td>
				...
				<tr>
					<td>6-9-1-7-4-2-8</td>
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_6b', 'value'=>set_value('respuesta_6b')));?></td>
				...
				<tr>
					...
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_7a', 'value'=>set_value('respuesta_7a')));?></td>
				...
				<tr>
					...
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_7b', 'value'=>set_value('respuesta_7b')));?></td>
				...
				<tr>
					...
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_8a', 'value'=>set_value('respuesta_8a')));?></td>
				...
				<tr>
					...
					<td><?= form_input(array('type'=>'text','name'=>'respuesta_8b', 'value'=>set_value('respuesta_8b')));?></td>
