	...
	<?= form_hidden('etapa', $etapa); ?>
		...
		<table class='table table-striped table-hover table-bordered table-condensed'>
			...
			<tr>
				...
				<td><?= form_dropdown('puntaje_item_1a',$valores_item, set_radio('puntaje_item_1a')); ?></td>
			</tr>
			<tr>				
				<td>6-3</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_1b',$valores_intento, set_radio('puntaje_intento_1b')); ?></td>
				<td><?= form_dropdown('puntaje_item_1b',$valores_item, set_radio('puntaje_item_1b')); ?></td>
			</tr>
			<tr>				
				<td rowspan='2'>2</td>
				<td>5-8-2</td>
				...
				<td><?= form_dropdown('puntaje_item_2a',$valores_item, set_radio('puntaje_item_2a')); ?></td>
			</tr>
			<tr>
				<td>6-9-4</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_2b',$valores_intento, set_radio('puntaje_intento_2b')); ?></td>
				<td><?= form_dropdown('puntaje_item_2b',$valores_item, set_radio('puntaje_item_2b')); ?></td>
			</tr>
			<tr>
				<td rowspan='2'>3</td>
				<td>7-2-8-6</td>
				...
				<td><?= form_dropdown('puntaje_item_3a',$valores_item, set_radio('puntaje_item_3a')); ?></td>
			</tr>
			<tr>
				<td>6-4-3-9</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_3b',$valores_intento, set_radio('puntaje_intento_3b')); ?></td>
				<td><?= form_dropdown('puntaje_item_3b',$valores_item, set_radio('puntaje_item_3b')); ?></td>
			</tr>
			<tr>
				<td rowspan='2'>4</td>
				<td>4-2-7-3-1</td>
				...
				<td><?= form_dropdown('puntaje_item_4a',$valores_item, set_radio('puntaje_item_4a')); ?></td>
			</tr>
			<tr>
				<td>7-5-8-3-6</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_4b',$valores_intento, set_radio('puntaje_intento_4b')); ?></td>
				<td><?= form_dropdown('puntaje_item_4b',$valores_item, set_radio('puntaje_item_4b')); ?></td>
			</tr>
			<tr>
				<td rowspan='2'>5</td>
				<td>3-9-2-4-8-7</td>
				...
				<td><?= form_dropdown('puntaje_item_5a',$valores_item, set_radio('puntaje_item_5a')); ?></td>
			</tr>
			<tr>
				<td>6-1-9-4-7-3</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_5b',$valores_intento, set_radio('puntaje_intento_5b')); ?></td>
				<td><?= form_dropdown('puntaje_item_5b',$valores_item, set_radio('puntaje_item_5b')); ?></td>
			</tr>
			<tr>
				<td rowspan='2'>6</td>
				<td>4-1-7-9-3-8-6</td>
				...
				<td><?= form_dropdown('puntaje_item_6a',$valores_item, set_radio('puntaje_item_6a')); ?></td>
			</tr>
			<tr>
				<td>6-9-1-7-4-2-8</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_6b',$valores_intento, set_radio('puntaje_intento_6b')); ?></td>
				<td><?= form_dropdown('puntaje_item_6b',$valores_item, set_radio('puntaje_item_6b')); ?></td>
			</tr>
			<tr>
				<td rowspan='2'>7</td>
				...
				<td><?= form_dropdown('puntaje_item_7a',$valores_item, set_radio('puntaje_item_7a')); ?></td>
			</tr>
			<tr>
				<td>5-8-1-3-2-6-4-7</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_7b',$valores_intento, set_radio('puntaje_intento_7b')); ?></td>
				<td><?= form_dropdown('puntaje_item_7b',$valores_item, set_radio('puntaje_item_7b')); ?></td>
			</tr>
			<tr>
				<td rowspan='2'>8</td>
				...
				<td><?= form_dropdown('puntaje_item_8a',$valores_item, set_radio('puntaje_item_8a')); ?></td>
			</tr>
			<tr>
				<td>7-1-3-9-4-2-5-6-8</td>
				<td></td>
				<td><?= form_dropdown('puntaje_intento_8b',$valores_intento, set_radio('puntaje_intento_8b')); ?></td>
				<td><?= form_dropdown('puntaje_item_8b',$valores_item, set_radio('puntaje_item_8b')); ?></td>
			</tr>		
			<tr>
