...
<br />
<!-- legend -->
<?= form_open('subject/examen_laboratorio_insert', array('class'=>'form-horizontal')); ?>
		...
		<table class='table table-bordered table-striped table-hover'>
			...
			<tbody>
				...
				<tr>
					...
					<td style='text-align:center;'><?= form_radio(array('name'=>'creatinina_nom_anom','value'=>'Anormal_con','checked'=>set_radio('creatinina_nom_anom', 'Anormal_con')));?></td>
