...
?>	
<?= form_open('subject/tmt_b_update', array('class'=>'form-horizontal','id'=>'form_tmtb')); ?>
	...
	<table class="table table-bordered table-striper table-hover">
			...
			<td>
				...
				<?php
					if($list[0]->status == 'Record Complete' OR $list[0]->status == 'Query' )
					{
						...
						{
							if(strpos($_SESSION['role_options']['subject'], 'tmt_b_verify')){
							...
							if(strpos($_SESSION['role_options']['subject'], 'tmt_b_update')){
		...
		<tr>
			<td colspan='2' style='text-align:center;'>
				<?php
					if(isset($_SESSION['role_options']['subject']) AND strpos($_SESSION['role_options']['subject'], 'tmt_b_update') AND $list[0]->status != 'Form Approved and Locked'){
				?>
...
<b>Aprobacion del Monitor:</b><br />
	...
	<?php
		...
		if(isset($_SESSION['role_options']['subject']) 
			AND strpos($_SESSION['role_options']['subject'], 'tmt_b_verify') 
...
<br /><b>Cierre:</b><br />
	...
	<?php
		...
		if(isset($_SESSION['role_options']['subject']) 
			AND strpos($_SESSION['role_options']['subject'], 'tmt_b_lock')
...
<!--Signature-->
	...
	<?php
		...
		if(isset($_SESSION['role_options']['subject']) 
			AND strpos($_SESSION['role_options']['subject'], 'tmt_b_signature')
