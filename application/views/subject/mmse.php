...
<?= form_open('subject/mmse_insert', array('class'=>'form-horizontal')); ?>    
    ...
    <table class="table table-condensed table-bordered table-striped table-hover">          
	    ...
	    <tr>
	    	...
	    	<td><?= form_dropdown('en_que_ano_estamos_puntaje',$puntaje,set_radio('en_que_ano_estamos_puntaje')); ?></td>
	    </tr>

	    <tr>
	    	<td colspan='2'>¿En qué Estación del año estamos?</td>
	    	<td><?= form_dropdown('en_que_estacion_estamos_puntaje',$puntaje,set_radio('en_que_estacion_estamos_puntaje')); ?></td>
	    </tr>

	    <tr>
	    	<td colspan='2'>¿En qué Mes estamos?</td>
	    	<td><?= form_dropdown('en_que_mes_estamos_puntaje',$puntaje,set_radio('en_que_mes_estamos_puntaje')); ?></td>
	    </tr>

	    <tr>
	    	<td colspan='2'>¿En qué Día de la semana estamos?</td>
	    	<td><?= form_dropdown('en_que_dia_estamos_puntaje',$puntaje,set_radio('en_que_dia_estamos_puntaje')); ?></td>
	    </tr>

	    <tr>
	    	<td colspan='2'>¿En qué Fecha estamos?</td>
	    	<td><?= form_dropdown('en_que_fecha_estamos_puntaje',$puntaje,set_radio('en_que_fecha_estamos_puntaje')); ?></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	    	...
	    	<td><?= form_dropdown('en_que_region_estamos_puntaje',$puntaje,set_radio('en_que_region_estamos_puntaje')); ?></td>
	    </tr>
	...
	<table class="table table-striped table-bordered table-striped table-hover">
		...
		<tr>
			...
			<td><?= form_dropdown('donde_estas_ahora_puntaje',$puntaje,set_radio('donde_estas_ahora_puntaje')); ?></td>
		</tr>	
		<tr>
			...
			<td><?= form_dropdown('comuna_estamos_puntaje',$puntaje,set_radio('comuna_estamos_puntaje')); ?></td>
		</tr>
		<tr>
			...
			<td><?= form_dropdown('barrio_estamos_puntaje',$puntaje,set_radio('barrio_estamos_puntaje')); ?></td>
		</tr>
		<tr>
			...
			<td><?= form_dropdown('edificio_estamos_puntaje',$puntaje,set_radio('edificio_estamos_puntaje')); ?></td>
		</tr>
		<tr>
	 ...
	 [pausa], PESO [pausa], MESA [pausa]. Ahora dígame esas palabras (se puede repetir hasta cinco veces, pero registre sólo el primer intento).
		...
		<tr>
			...
			<td><?= form_dropdown('manzana_puntaje',$puntaje,set_radio('manzana_puntaje')); ?></td>
		</tr>
		<tr>
			<td>PESO</td>
			<td><?= form_input(array('type'=>'text','name'=>'peso', 'id'=>'peso', 'value'=>set_value('peso'))); ?></td>
			<td><?= form_dropdown('peso_puntaje',$puntaje,set_radio('peso_puntaje')); ?></td>
		</tr>
		<tr>
			<td>MESA</td>
			<td><?= form_input(array('type'=>'text','name'=>'mesa', 'id'=>'mesa', 'value'=>set_value('mesa'))); ?></td>
			<td><?= form_dropdown('mesa_puntaje',$puntaje,set_radio('mesa_puntaje')); ?></td>
		</tr>
		...
		<tr>
			...
			<td><?= form_dropdown('cuanto_93_puntaje',$puntaje,set_radio('cuanto_93_puntaje')); ?></td>
		<tr>
		...
		<tr>
			...
			<td><?= form_dropdown('cuanto_86_puntaje',$puntaje,set_radio('cuanto_86_puntaje')); ?></td>
		</tr>
		<tr>
			...
			<td><?= form_dropdown('cuanto_79_puntaje',$puntaje,set_radio('cuanto_79_puntaje')); ?></td>
		</tr>
		<tr>
			...
			<td><?= form_dropdown('cuanto_72_puntaje',$puntaje,set_radio('cuanto_72_puntaje')); ?></td>
		</tr>
		<tr>
			...
			<td><?= form_dropdown('cuanto_65_puntaje',$puntaje,set_radio('cuanto_65_puntaje')); ?></td>
		</tr>	
		<tr>
		...
		<tr>
			...
			<td><?= form_dropdown('no_si_cuando_porque_puntaje',$puntaje,set_radio('no_si_cuando_porque_puntaje')); ?></td>
		</tr>
		<tr>
...
Dibujo: página con el diagrama).</td>
		...
		<tr>	
			...
			<td><?= form_dropdown('tomar_con_la_mano_derecha_puntaje',$puntaje,set_radio('tomar_con_la_mano_derecha_puntaje')); ?></td>
		</tr>
		<tr>
			...
			<td><?= form_dropdown('doblar_por_la_mitad_puntaje',$puntaje,set_radio('doblar_por_la_mitad_puntaje')); ?></td>
		</tr>
		<tr>
			<td>PONER EN EL PISO	
			<td><?= form_input(array('type'=>'text','name'=>'poner_en_el_piso', 'id'=>'poner_en_el_piso', 'value'=>set_value('poner_en_el_piso'))); ?></td>
			<td><?= form_dropdown('poner_en_el_piso_puntaje',$puntaje,set_radio('poner_en_el_piso_puntaje')); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?= form_dropdown('cierre_los_ojos_puntaje',$puntaje,set_radio('cierre_los_ojos_puntaje')); ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan='3'><?= form_dropdown('escritura_puntaje',$puntaje,set_radio('escritura_puntaje')); ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan='3'><?= form_dropdown('dibujo_puntaje',$puntaje,set_radio('dibujo_puntaje')); ?></td>
		</tr>	
		<tr>
			<td style='font-weight:bold;'>PUNTAJE TOTAL: </td>
			<td colspan='2' id='puntaje_total_td' style='font-weight:bold;'></td>
		</tr>
		<tr>
