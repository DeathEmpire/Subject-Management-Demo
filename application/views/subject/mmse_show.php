...
<?= form_open('subject/mmse_update', array('class'=>'form-horizontal','id'=>'form_mmse')); ?>    
	...
	<table class="table table-condensed table-bordered table-striped table-hover">
	 ...
	 [pausa], PESO [pausa], MESA [pausa]. Ahora dígame esas palabras (se puede repetir hasta cinco veces, pero registre sólo el primer intento).
		...
		<tr><td colspan='4'>A.- Realizar <?= form_checkbox($realizar_a, 1, set_checkbox('realizar_a',1,(($list[0]->realizar_a == 1) ? true : false)));?></td></tr>
		<tr>
		...
		<tr><td colspan='3'>B.- Realizar <?= form_checkbox($realizar_b, 1, set_checkbox('realizar_b',1,(($list[0]->realizar_b == 1) ? true : false)));?></td></tr>
		<tr>
