...
<div class="row">
	...
	<table class='table table-striped table-hover table-bordered table-condensed'>			
		<tbody>
			...
			<tr>
				<td>Total correctas</td>
				<td><?= form_dropdown('total_correctas_5', $de0_a5,  set_value('total_correctas_5', $list[0]->total_correctas_5),array('id'=>'total_correctas_5')); ?></td>					
			</tr>
			<tr>
				<td>Total incorrectas</td>
				<td><?= form_dropdown('total_incorrectas_5', $de0_a5,  set_value('total_incorrectas_5', $list[0]->total_incorrectas_5),array('id'=>'total_incorrectas_5')); ?></td>				
			</tr>			
			<tr>
