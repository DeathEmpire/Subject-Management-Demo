...
?>
	...
	<?= form_hidden('id', $list[0]->id); ?>
		...
		<table class='table table-striped table-hover table-bordered table-condensed'>			
			...
			<tr>
				<td>Visita: </td>
				<td><?= form_dropdown('etapa',$etapas, set_value('etapa', $list[0]->etapa)); ?></td>
			</tr>
	...
	<?php }?>
			...
			<b>Monitor Approve:</b><br />
				...
				?>
					<?= form_open('subject/examen_fisico_adicional_verify', array('class'=>'form-horizontal')); ?>    	
			...
			<br /><b>Lock:</b><br />
				...
				?>
					<?= form_open('subject/examen_fisico_adicional_lock', array('class'=>'form-horizontal')); ?>
					<?= form_hidden('id', $list[0]->id); ?>    	
					<?= form_hidden('subject_id', $subject->id); ?>					
					<?= form_hidden('current_status', $list[0]->status); ?>
			...
			<!--Signature-->
				...
				?>
					<?= form_open('subject/examen_fisico_adicional_signature', array('class'=>'form-horizontal')); ?>    	
					<?= form_hidden('id', $list[0]->id); ?>    	
					<?= form_hidden('subject_id', $subject->id); ?>					
					<?= form_hidden('current_status', $list[0]->status); ?>
