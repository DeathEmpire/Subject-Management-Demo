<legend style='text-align:center;'>Examen Laboratorio (Adicional)</legend>
<b>Sujeto Actual:</b>
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td><?= anchor('subject/examen_laboratorio_adicional_show/'. $subject->id .'/'.$v->id,'Ver', array('class'=>'btn btn-default')); ?></td>
				</tr>
