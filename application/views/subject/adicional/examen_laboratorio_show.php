		...
		$.post("<?php echo base_url('query/query'); ?>",
			{
				...
				"form": "examen_laboratorio_adicional",
				"form_nombre" : "Examen Laboratorio",
...
<b>Aprobacion del Monitor:</b><br />
	...
	?>
		<?= form_open('subject/examen_laboratorio_adicional_verify', array('class'=>'form-horizontal')); ?>    	
		<?= form_hidden('subject_id', $subject->id); ?>		
...
<br /><b>Cierre:</b><br />
	...
	?>
		<?= form_open('subject/examen_laboratorio_adicional_lock', array('class'=>'form-horizontal')); ?>    	
		<?= form_hidden('subject_id', $subject->id); ?>		
		<?= form_hidden('current_status', $list[0]->status); ?>
		<?= form_hidden('id', $list[0]->id); ?>
...
<!--Signature-->
	...
	?>
		<?= form_open('subject/examen_laboratorio_adicional_signature', array('class'=>'form-horizontal')); ?>    	
		<?= form_hidden('subject_id', $subject->id); ?>		
		<?= form_hidden('current_status', $list[0]->status); ?>
		<?= form_hidden('id', $list[0]->id); ?>
