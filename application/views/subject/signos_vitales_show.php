...
$(function(){
	...
	$("input[name=realizado]").change(function(){
		if($(this).val() == 0){
			...
			$("#form_signos :input").each(function(){
	...
	<table class="table table-bordered table-striper table-hover">
		...
		<tr>
			<td colspan='2' style='text-align:center;'>
				<?php
					if(isset($_SESSION['role_options']['subject']) AND strpos($_SESSION['role_options']['subject'], 'signos_vitales_update') AND $list[0]->status != 'Form Approved and Locked'){
				?>
